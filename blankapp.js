...
//--------------------------------
	...
	var showPic = function() {
		if(i == 1) {
			$('ul li:nth-child(' + imageLength + ')').fadeOut(fadeOutTime);
			setTimeout(function() {
					$('ul li:nth-child(' + i + ')').fadeIn(fadeInTime);
					i++;
				}, fadeOutTime + 3);
		} else if (i == imageLength) {
			$('ul li:nth-child(' + imageLengthMin + ')').fadeOut(fadeOutTime);
			setTimeout(function() {
				$('ul li:nth-child(' + i + ')').fadeIn(fadeInTime);
				i = 1;
			}, fadeOutTime + 3);
			...
			$('ul li:nth-child(' + (i - 1) + ')').fadeOut(fadeOutTime);
			setTimeout(function() { 
				$('ul li:nth-child(' + i + ')').fadeIn(fadeInTime);
				i++;
			}, fadeOutTime + 3);
	...
	$('ul li:nth-child(' + imageLength + ')').show();
